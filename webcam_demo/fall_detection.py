...
class VideoReader(object):
    ...
    def __iter__(self):
        self.cap = cv2.VideoCapture(self.file_name, self.option)
...
if __name__ == '__main__':
    ...
    print(f'Run demo on {args.device} and draw option: {args.draw}')
    ...
    image_provider = VideoReader(gst_str, cv2.CAP_GSTREAMER)
